...
impl TokenKind {
    ...
    pub fn from_keyword(word: &str) -> Option<TokenKind> {
        ...
        match upper.as_str() {
            ...
            "RECORD-KEY" | "RECORD KEY" => Some(TokenKind::RecordKey),
            "ALTERNATE" => Some(TokenKind::AlternateRecordKey),
            "FILE-STATUS" | "FILE STATUS" => Some(TokenKind::FileStatus),
            ...
            "ON SIZE ERROR" => Some(TokenKind::OnSizeError),
            "NOT ON SIZE ERROR" => Some(TokenKind::NotOnSizeError),
            ...
            "NOT AT END" => Some(TokenKind::NotAtEnd),
            "INVALID" => Some(TokenKind::InvalidKey),
            "NOT INVALID" => Some(TokenKind::NotInvalidKey),
            "WITH" => Some(TokenKind::With),
            "LOCK" => Some(TokenKind::Lock),
            "NO LOCK" => Some(TokenKind::NoLock),
            ...
            "NOT ON OVERFLOW" => Some(TokenKind::NotOnOverflow),
